...
**[中文](https://gitee.com/fantasticperson22/claude-code/blob/minify/docs/README.zh-CN.md)** | English
...
|----------|-------------|
| [Full Usage Guide (Chinese)](https://gitee.com/fantasticperson22/claude-code/blob/minify/docs/README.zh-CN.md) | Complete API reference, configuration, examples, FAQ, and comparison with the original Claude Code |
| [Comparison & Use Cases](https://gitee.com/fantasticperson22/claude-code/blob/minify/docs/README.zh-CN.md#与原版-claude-code-的对比) | Detailed comparison table between Claude Code CLI and claude-code-minify |
| [Core API Reference](https://gitee.com/fantasticperson22/claude-code/blob/minify/docs/README.zh-CN.md#核心-api) | ClaudeSDK, Session, streaming, custom tools, skills, memory |
| [Built-in Tools](https://gitee.com/fantasticperson22/claude-code/blob/minify/docs/README.zh-CN.md#内置工具) | file_read, file_write, file_edit, bash, grep, glob, todo_write, ask_user |
| [Provider Guide](https://gitee.com/fantasticperson22/claude-code/blob/minify/docs/README.zh-CN.md#provider-详解) | OpenAI, Anthropic, and custom providers |
| [Type Reference](https://gitee.com/fantasticperson22/claude-code/blob/minify/docs/README.zh-CN.md#类型定义参考) | Full TypeScript type definitions |
| [Build & Publish](https://gitee.com/fantasticperson22/claude-code/blob/minify/docs/README.zh-CN.md#构建与发布) | Build commands, npm publishing, dual-format output |
...
> See the [full comparison table](https://gitee.com/fantasticperson22/claude-code/blob/minify/docs/README.zh-CN.md#与原版-claude-code-的对比) for 25+ dimensions.
...
> See [detailed use cases](https://gitee.com/fantasticperson22/claude-code/blob/minify/docs/README.zh-CN.md#适用场景).
